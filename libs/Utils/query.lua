...
return function(reql, token, callback)
	...
	processor.cbs[token] = { f = callback, raw = reql._data.raw, keepAlive = reql._data.changes, getterWetter = reql._data.megaSuperGetData, conn = reql.conn, encoded = validEncode, caller = reql.caller }
end
